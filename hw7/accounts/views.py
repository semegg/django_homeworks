...
def follow_user_view(request, username):
    ...
    return redirect('accounts:profile_detail', username=followed_user.username)
...
def show_followers_view(request, username):
    ...
    data = {'followers': followers,
            'profile': profile}
    return render(request, 'accounts/profile/show_followers.html', data)

def show_followed_view(request, username):
    user = get_object_or_404(User, username=username)
    ...
    return render(request, 'accounts/profile/show_followed.html', data)